        ...
        <!-- Start Page Content -->
            <div class="container pb50">
              ...
              <div class="row p0 bg-light">
                        ...
                        <div class="modal-body p0">
                          <div class="">
                              <div class="bg-white box-shadow p0">
                                <?php echo form_open_multipart('submit/submit_ticket/1'); ?>
                ...
                <!--Inbox-->
                <div ng-show="action == 'inbox'" ng-init="getInboxU()">
                <!--Middle col-->
                <div class="col-md-3 bg-light p0 border-right2 border-left2">
                  ...
                  <a ng-show="ticketsInbox != 'false'"  href="" ng-repeat="tik in ticketsInbox" ng-click="selectU($index)">
                    <div class="p20 bg-white-effect2">
                      <p class="cap m0 text-gray fw600" ng-class="{'pl10' : tik.tic_opened_user == 0}">
                          <span class="none absolute unread-circle" ng-class="{'inline' : tik.tic_opened_user == 0}">
                ...
                <div class="col-md-7 bg-white p0" ng-show="ticketsInbox != 'false'">
                  <div class="bg-white border-bottom2 text-gray">
                    <div class="plr20 ptb15 inline">
                      <a href="" ng-click="deleteU()" class="plr20 fa fa-trash border-right-dark"></a>
            ...
            <!--Trash-->
            <div ng-show="action == 'trash'" ng-init="getTrashU()">
            <!--Middle col-->
            <div class="col-md-3 bg-light p0 border-right2 border-left2">
              <div class="border-bottom2 ptb15 text-gray plr20 cap">trash</div>

              <h4 class="p50" ng-show="ticketsInbox == 'false'">You've got no tickets.</h4>
              <a ng-show="ticketsInbox != 'false'" href="" ng-repeat="tik in ticketsTrash" ng-click="select($index)">
                <div class="p20 bg-white-effect2">
                  <p class="cap m0 text-gray fw600" ng-class="{'pl10' : tik.tic_opened_user == 0}">
                      <span class="none absolute unread-circle" ng-class="{'inline' : tik.tic_opened_user == 0}">
                      <svg width="6" height="6">
