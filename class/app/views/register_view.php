  ...
  <div class="account-bg bg blur relative" style="background:url(<?php echo base_url(); ?>assets/img/lion.png)no-repeat center center; background-size:cover;">
    ...
    <div class="container relative z-index">
      ...
      <div class="row p-t-150">
        <div class="col-md-6 p-0" style="background:url(<?php echo base_url(); ?>assets/img/lion.png)no-repeat center center; background-size:cover;height:473px;">
        ...
        <div class="col-md-6 bg-white" style="-webkit-box-shadow: -20px 0 30px 0 rgba(0,0,0,0.3); box-shadow: -20px 0 30px 0 rgba(0,0,0,0.3); z-index:999999; position:relative;">
          ...
          <div class="p-50">
            <h4 class="p-b-50">Register here</h4>

            <div class="relative">
              <input type="text" name="name" class="inputText border-bottom3 no-focus" required/>
              <span class="floating-label text-gray">Your full name</span>
            </div>
            ...
            <div class="center m-t-b-50"><div><input type="submit" value="register" class="btn-outline-b"></div></div>
          </div>
        </form>
          <span class="bottom-20 full-width absolute text-gray op-5 center">Already have an account? <a href="login.html" class="cap">sign in</a></span>
        </div>
      </div>
