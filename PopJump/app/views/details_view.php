...
<div class="center">
          ...
          <div class="mtb5 center inline round-small no-focus border-gray2">
              <input type="text" name="email" placeholder="Profile email" class="ptb5 pl10 pr50 font-12 no-border round-small" required>
            </div><br>
                <div class="mtb5 center inline round-small no-focus border-gray2">
                    <input type="text" name="avatar" placeholder="Profile avatar" class="ptb5 pl10 pr50 font-12 no-border round-small" required>
                </div><br>
                  <div class="mtb5 center inline round-small no-focus border-gray2">
                    <input type="text" name="id" placeholder="Profile ID" class="ptb5 pl10 pr50 font-12 no-border round-small" required>
                  </div><br>
                    <div class="mtb5 center inline round-small no-focus border-gray2">
                      <input type="text" name="url" placeholder="Profile url" class="ptb5 pl10 pr50 font-12 no-border round-small" required>
                    </div>
